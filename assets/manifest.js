...
window.ASSET_MANIFEST = {
  ...
  atlases: [
    {
      /* Town Center L1 — the founding hut on a 2×2 footprint, authored and
         ...
         Both tribes share the hut: faction banners only arrive at L3, per the
         level design — which is also why this art may bake its own cloth. */
